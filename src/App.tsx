...
function App() {
  ...
  return (
    <div className="w-full h-[100dvh] flex flex-col overflow-hidden bg-white dark:bg-[#121212] text-[#1A1A1A] dark:text-[#F3F4F6] pt-[env(safe-area-inset-top)] select-none relative">
      ...
      <div className="absolute bottom-0 left-0 right-0 w-full px-4 pb-[calc(1.5rem+env(safe-area-inset-bottom))] pointer-events-none flex justify-center" style={{ zIndex: 50 }}>
